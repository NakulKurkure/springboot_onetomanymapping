...
public class categoryController {
	...
	@Autowired
	//Spring boot automatically inject the one object into another object
	...
	@GetMapping("/api/categories?pageNumber=1&pageSize=2")
	public List<category> getAll(@RequestParam(value="pageNumber",defaultValue = "1",required = false) Integer pageNumber,
