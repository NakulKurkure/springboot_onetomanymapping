...
public class productController {
	...
	@GetMapping("/api/products?pageNumber=1&pageSize=2")
	//map to query parameters, form data, 
	public List<product> getAll(@RequestParam(value="pageNumber",defaultValue = "1",required = false) Integer pageNumber,
